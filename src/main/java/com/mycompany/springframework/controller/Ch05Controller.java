...
public class Ch05Controller {
	...
	public String createCookie(HttpServletResponse response) {
		...
		//cookie1.setMaxAge(60); //클라이언트 파일시스템의 저장하는 기간 설정 (없으면 브라우저 메모리에 저장)/ 설정하지 않으면 브라우저 메모리에 저장
		//cookie1.setDomain(".samsung.com"); // *.samsung.com 이라면 쿠키를 전송
		//cookie1.setSecure(true);//https에서만 쿠키클 전송
		//cookie1.setHttpOnly(true);//브라우저에 자바스크립트로 쿠키에 접근을 허용하지 않음
