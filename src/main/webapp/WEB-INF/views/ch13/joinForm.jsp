	...
	<div class="card-body">
        <form id="joinForm" method="post" action="join">
	       ...
	       <div class="input-group mt-2">
	          ...
	          <input id="mid" type="text" name="mname" class="form-control" value="${ch13Member.mname }">
	       </div>
	       <div class="input-group mt-2">
	       ...
	       <div class="input-group mt-2">
	          ...
	          <input id="meamil" type="email" name="memail" class="form-control" value="${ch13Member.memail}">
	       </div>
