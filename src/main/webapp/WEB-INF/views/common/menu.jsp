...
<div class="accordion" id="accordionMenu">
  <div class="accordion-item">
    ...
    <div id="ch01" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
   ...
   <div class="accordion-item">
    ...
    <div id="ch02" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
      <div class="accordion-body">
      	<ul>
  ...
  <div class="accordion-item">
    ...
    <div id="ch03" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
      <div class="accordion-body">
      	<ul>
  ...
  <div class="accordion-item">
    ...
    <div id="ch04" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
      <div class="accordion-body">
      	<ul>
