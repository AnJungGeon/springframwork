...
<div class="accordion" id="accordionMenu">
  <div class="accordion-item">
    ...
    <div id="ch01" class="accordion-collapse collapse ${chNum=='ch01'?'show':''}" data-bs-parent="#accordionExample">
   ...
   <div class="accordion-item">
    ...
    <div id="ch02" class="accordion-collapse collapse ${chNum=='ch02'?'show':''}" data-bs-parent="#accordionExample">
      <div class="accordion-body">
      	<ul>
  ...
  <div class="accordion-item">
    ...
    <div id="ch03" class="accordion-collapse collapse ${chNum=='ch03'?'show':''}" data-bs-parent="#accordionExample">
      <div class="accordion-body">
      	<ul>
    ...
    <div id="ch07" class="accordion-collapse collapse ${chNum=='ch07'?'show':''}" data-bs-parent="#accordionExample">
      <div class="accordion-body">
      	<ul>
      		...
      		<li><a href="${pageContext.request.contextPath}/ch07/objectScope2">데이터(객체) 사용 범위2</a></li>
      	</ul>
      </div>
    </div>
  </div>
  ...
  <div class="accordion-item">
    ...
    <div id="ch11" class="accordion-collapse collapse ${chNum=='ch11'?'show':''}" data-bs-parent="#accordionExample">
      <div class="accordion-body">
      	<ul>
  ...
  <div class="accordion-item">
    ...
    <div id="ch12" class="accordion-collapse collapse ${chNum=='ch12'?'show':''}" data-bs-parent="#accordionExample">
      <div class="accordion-body">
      	<ul>
   ...
   <div class="accordion-item">
    ...
    <div id="ch13" class="accordion-collapse collapse ${chNum=='ch13'?'show':''}" data-bs-parent="#accordionExample">
      <div class="accordion-body">
      	<ul>
  ...
  <div class="accordion-item">
    ...
    <div id="ch14" class="accordion-collapse collapse ${chNum=='ch14'?'show':''}" data-bs-parent="#accordionExample">
      <div class="accordion-body">
      	<ul>
